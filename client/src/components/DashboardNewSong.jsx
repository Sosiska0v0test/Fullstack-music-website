...
export const ImageLoader = ({ progress }) => {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      <div className="w-20 h-20 min-w-[40px] rounded-full flex items-center justify-center relative">
        <div
          className="animate-spin w-full h-full rounded-full border-t-4 border-pink-600 border-solid border-opacity-50"
          style={ { borderRightColor: 'transparent' } }
        ></div>
        <div className="absolute inset-0 flex items-center justify-center text-xl font-semibold text-color_white">
...
export const DisabledButton = () => {
  return (
    <button
      disabled
      type="button"
      className="text-white bg-yellow-500 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-yellow-500 dark:hover:bg-yellow-500 dark:focus:ring-yellow-500 inline-flex items-center"
    >
      <svg
        role="status"
...
const DashboardNewSong = () => {
  ...
  return (
    <div className="flex items-center justify-center p-4 border border-gray-300 rounded-md bg-primary">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
        <div className="flex flex-col items-center justify-center gap-4">
          <input
            type="text"
            placeholder="Type your song name"
            className="w-full p-3 rounded-md text-base font-semibold text-textDashboardCard outline-none shadow-sm border border-gray-300 bg-transparent"
            value={ songName }
          ...
          <div className="flex items-center justify-between gap-2 w-full flex-wrap">
            ...
            <div className="flex items-center justify-end w-full p-4">
              { isImageLoading || isAudioLoading ? (
                ...
                <motion.button
                  whileTap={ { scale: 0.75 } }
                  className="px-8 py-2 rounded-md text-white bg-buttonColor hover:shadow-lg hover:bg-textDashboardCard"
                  onClick={ saveSong }
                >
                  Send
                </motion.button>
    ...
    <div className="flex items-center justify-evenly w-full flex-wrap">
      ...
      <div className="flex flex-col items-center justify-center gap-4 ">
        <input
          ...
          className="w-full lg:w-300 p-3 rounded-md text-base font-semibold text-textDashboardCard outline-none shadow-sm border border-gray-300 bg-transparent"
          value={ artistName }
        ...
        <div className="w-full lg:w-300 p-3 flex items-center rounded-md  shadow-sm border border-gray-300">
          ...
          <input
            type="text"
            placeholder="your id"
            className="w-full text-base font-semibold text-textDashboardCard outline-none bg-transparent"
            value={ twitter }
