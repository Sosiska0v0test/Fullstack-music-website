    ...
    <div className="w-full p-4 flex items-center justify-center flex-col">
      <div className="w-full flex justify-center items-center gap-24">
        <NavLink
          ...
          className="flex items-center px-4 py-3 text-primary border rounded-md border-gray-300 hover:border-gray-400 hover:shadow-md cursor-pointer"
        >
          <IoAdd />
        </NavLink>
        <input
          ...
          className={ `w-52 px-4 text-white py-2 border ${isFocus ? "border-gray-500 shadow-md" : "border-gray-300"
      ...
      <div className="relative w-full my-4 p-4 py-12 border border-gray-300 rounded-md bg-textColor">
...
export const SongCard = ({ data, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative w-44 min-w-210 px-4 py-2 cursor-pointer hover:shadow-xl hover:bg-cartBgHover bg-gray-300 shadow-md rounded-lg flex flex-col items-center"
    ...
    >
      ...
      <p className="text-base text-headingColor text-center font-semibold my-2">
        ...
        <span className="block text-sm text-textDashboardCard  my-1">{ data.artist }</span>
      </p>
