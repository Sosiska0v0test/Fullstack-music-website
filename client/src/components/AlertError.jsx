...
const AlertError = ({ msg }) => {
  return (
    ...
    >
      <div className="w-380 bg-red-400 rounded-md shadow-md backdrop-blur-md px-4 py-4 flex items-center gap-4">
        <BsEmojiFrown className="text-xl text-textDashboardCard" />
