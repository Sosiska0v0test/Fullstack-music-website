...
const MusicPlayer = () => {
  ...
  return (
    <div className="w-full full flex items-center gap-3 overflow-hidden" style={ { backgroundColor: 'rgba(245, 133, 73, 0.5)' } }>
      <div
      ...
      >
        ...
        <div className="flex items-start flex-col">
          <p className="text-xl text-textDashboardCard font-semibold">
          ...
          <p className="text-textDashboardCard">
            { allSongs[song]?.artist }{ " " }
            <span className="text-sm text-textDashboardCard font-semibold">
          ...
          >
            <RiPlayListFill className="text-textDashboardCard hover:text-textDashboardCard text-3xl cursor-pointer" />
          </motion.i>
        </div>
        ...
        <div className="h-full flex items-center justify-center flex-col gap-3">
          <motion.i whileTap={ { scale: 0.8 } } onClick={ closeMusicPlayer }>
            <IoMdClose className="text-textDashboardCard hover:text-textDashboardCard text-2xl cursor-pointer" />
          </motion.i>
          <motion.i whileTap={ { scale: 0.8 } } onClick={ togglePlayer }>
            <IoArrowRedo className="text-textDashboardCard hover:text-textDashboardCard text-2xl cursor-pointer" />
          </motion.i>
        </div>
      </div>
      ...
      { miniPlayer && (
        ...
        >
          <div className="w-40 h-40 rounded-full flex items-center justify-center  relative ">
            <div className="absolute inset-0 rounded-full bg-orange-400 blur-xl animate-pulse"></div>
            <img
    ...
    <div className="absolute left-4 bottom-24 gap-2 py-2 w-350 max-w-[350px] h-510 max-h-[510px] flex flex-col overflow-y-scroll scrollbar-thin rounded-md shadow-md bg-primary">
      { allSongs.length > 0 ? (
        allSongs.map((music, index) => (
          ...
          >
            <IoMusicalNote className="text-textDashboardCard group-hover:text-textDashboardCard text-2xl cursor-pointer" />

            <div className="flex items-start flex-col">
              <p className="text-lg text-textDashboardCard font-semibold">
